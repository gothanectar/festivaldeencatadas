...
const WelcomeSection: React.FC = () => {
  return (
    <section className="p-4 sm:p-6 bg-earth-sand text-center">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-green-forest">Bem-vindo ao Paraíso do Jazz na Ilha do Mel!</h2>
      <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto text-earth-dark">
